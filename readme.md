...
[sudoSignals](https://www.sudosignals.com/) is an application monitor and remote operation service.
...
```shell
tdm add package github.com/SudoMagicCode/sudoSignals_td_plugin
``` 
